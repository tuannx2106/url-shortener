...
import fbLogo from './assets/img/icon-facebook.svg'
import igLogo from './assets/img/icon-instagram.svg'
import ttLogo from './assets/img/icon-twitter.svg'
import piLogo from './assets/img/icon-pinterest.svg'
    ...
    <div className="App">
      <header className="header container">
        ...
        <nav className="header__nav">
          <div className="header__nav-item">Features</div>
          ...
          <div className="footer__information">
            <div className="footer__inner">
              <div className="footer__link-group">
                <h4 className="headline headline--md">Features</h4>
                <nav>
              ...
              <div className="footer__link-group">
                <h4 className="headline headline--md">Resources</h4>
                <nav>
                  <a href="/">Blog</a>
                  <a href="/">Developers</a>
                  <a href="/">Support</a>
              ...
              <div className="footer__link-group">
                <h4 className="headline headline--md">Company</h4>
                <nav>
                  <a href="/">About</a>
                  <a href="/">Our Team</a>
                  <a href="/">Careers</a>
            ...
            <div className="footer__sns">
              ...
              <a href="/"><img src={ttLogo} alt="twitter logo"/></a>
              <a href="/"><img src={piLogo} alt="pinterest logo"/></a>
            </div>
          </div>
        </div>
      </footer>
      {/* <div className="container">
        <h1 className="headline headline--xxl">More than just shorter links</h1>
        <br/>
        <h2 className="headline headline--xl">Advanced Statistics</h2>
        <br/>
        <h2 className="headline headline--lg">Fully Customizable</h2>
      </div> */}
    </div>
  );
}
