        ...
        <div className="footer__information">
          <div className="footer__inner">
            <div className="footer__link-group">
              ...
              <nav>
                <a href="/" className="link link--primary link--lg">Link Shortening</a>
                <a href="/" className="link link--primary link--lg">Brand Links</a>
                <a href="/" className="link link--primary link--lg">Analytics</a>
              </nav>
            </div>
            <div className="footer__link-group">
              <h4 className="headline headline--md">Resources</h4>
              <nav>
                <a href="/" className="link link--primary link--lg">Blog</a>
                <a href="/" className="link link--primary link--lg">Developers</a>
                <a href="/" className="link link--primary link--lg">Support</a>
              </nav>
            </div>
            <div className="footer__link-group">
              <h4 className="headline headline--md">Company</h4>
              <nav>
                <a href="/" className="link link--primary link--lg">About</a>
                <a href="/" className="link link--primary link--lg">Our Team</a>
                <a href="/" className="link link--primary link--lg">Careers</a>
                <a href="/" className="link link--primary link--lg">Contact</a>
              </nav>
            </div>
          </div>
          <div className="footer__sns">
            <a href="/" className="link"><img src={fbLogo} alt="facebook logo" /></a>
            <a href="/" className="link"><img src={igLogo} alt="instagram logo" /></a>
            <a href="/" className="link"><img src={ttLogo} alt="twitter logo" /></a>
            <a href="/" className="link"><img src={piLogo} alt="pinterest logo" /></a>
          </div>
        </div>
      </div>
    </footer>
